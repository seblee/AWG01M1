...
uint16_t Get_Water_level(uint8_t u8Type)
{
    ...
    uint16_t u16AI_TANK=0;
		...
		{			
				...
				if (abs(u16AI_TANK-WL_M)<= WL_OFFSET)
				{
						u16WL = S_M;
				}
				else
				if (abs(u16AI_TANK-WL_U)<= WL_OFFSET)
				{
						u16WL = S_U;
				}
				else
			...
			case ACL_FILLTER:
				{
						...
						u16RemianTime=g_sVariable.gPara.alarm[ACL_FILLTER].alarm_param-g_sVariable.status.u16Runtime[1][DO_FILLTER_BPOS];
			...
			case ACL_FILLTER_ELEMENT_0:
				{
						...
						u16RemianTime=g_sVariable.gPara.alarm[ACL_FILLTER_ELEMENT_0].alarm_param-g_sVariable.status.u16Runtime[1][DO_FILLTER_ELEMENT_BPOS_0];
						u16FiliterStatus=(u16RemianTime+u16Filiter_OF-1)/u16Filiter_OF;
			...
			case ACL_FILLTER_ELEMENT_1:
				{
						...
						u16RemianTime=g_sVariable.gPara.alarm[ACL_FILLTER_ELEMENT_1].alarm_param-g_sVariable.status.u16Runtime[1][DO_FILLTER_ELEMENT_BPOS_1];
						u16FiliterStatus=(u16RemianTime+u16Filiter_OF-1)/u16Filiter_OF;
			...
			case ACL_FILLTER_ELEMENT_2:
				{
						...
						u16RemianTime=g_sVariable.gPara.alarm[ACL_FILLTER_ELEMENT_2].alarm_param-g_sVariable.status.u16Runtime[1][DO_FILLTER_ELEMENT_BPOS_2];
						u16FiliterStatus=(u16RemianTime+u16Filiter_OF-1)/u16Filiter_OF;
			...
			case ACL_FILLTER_ELEMENT_3:
				{
						...
						u16RemianTime=g_sVariable.gPara.alarm[ACL_FILLTER_ELEMENT_3].alarm_param-g_sVariable.status.u16Runtime[1][DO_FILLTER_ELEMENT_BPOS_3];
						u16FiliterStatus=(u16RemianTime+u16Filiter_OF-1)/u16Filiter_OF;
